...
const API_PREFIX =
  "development" === process.env.NODE_ENV ? "/api/api/" : "/api/"; // use dev or product
const TEST_URL = "https://yesno.wtf/api";
const INDEX_PREFIX = API_PREFIX + "index/"; // dev mode used.
...
const PUBLISH_TIME_RANGE_URI =
  INDEX_PREFIX + "getInfoByWorkTypePublishTimeRange";
const WHOLE_URI =
  INDEX_PREFIX + "getInfoByWorkTypeQualificationCompanyNameSchool";
    ...
    data: [
      {
        ...
        companyName: "腾讯",
        recruitWork:
          "我们的qq遍布全国，我们的微信遍布全国，大人小孩都会用，还有游戏，小孩子肯定要玩",
        recruitCitys: "深圳,北京",
        qualifications: 4,
        school: null,
      ...
      },
      {
        ...
        companyName: "阿里巴巴",
        recruitWork:
          "我们公司是阿里巴巴，我们是很厉害的，你可能听说过，也可能没听说过，但是我告诉你，就来就牛逼的飞上天了",
